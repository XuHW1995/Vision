...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public XLua.LuaEnv __Gen_Delegate_Imp4(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaMgr __Gen_Delegate_Imp5()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                XLuaMgr __gen_ret = (XLuaMgr)translator.GetObject(L, err_func + 1, typeof(XLuaMgr));
                LuaAPI.lua_settop(L, err_func - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<XLua.LuaTable>(__Gen_Delegate_Imp2);
			}
